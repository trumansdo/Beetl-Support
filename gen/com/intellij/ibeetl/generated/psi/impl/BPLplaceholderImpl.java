...
import com.intellij.ibeetl.generated.psi.BPLplaceholder;
...
public abstract class BPLplaceholderImpl extends BeetlCompositePsiElement implements BPLplaceholder {

  public BPLplaceholderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitLplaceholder(this);
  }
