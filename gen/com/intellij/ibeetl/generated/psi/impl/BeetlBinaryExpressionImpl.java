...
public class BeetlBinaryExpressionImpl extends BeetlCompositeElement implements BeetlBinaryExpression {
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof BeetlVisitor) accept((BeetlVisitor)visitor);
    else super.accept(visitor);
  }

  @Override
  @NotNull
  public List<BeetlLiteral> getLiteralList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BeetlLiteral.class);
  }
