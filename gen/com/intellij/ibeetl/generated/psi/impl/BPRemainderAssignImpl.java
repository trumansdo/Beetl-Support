...
import com.intellij.ibeetl.generated.psi.BPRemainderAssign;
...
public abstract class BPRemainderAssignImpl extends BeetlCompositePsiElement implements BPRemainderAssign {

  public BPRemainderAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitRemainderAssign(this);
  }
