...
import com.intellij.ibeetl.generated.psi.BPBitXorAssign;
...
public abstract class BPBitXorAssignImpl extends BeetlCompositePsiElement implements BPBitXorAssign {

  public BPBitXorAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitBitXorAssign(this);
  }
