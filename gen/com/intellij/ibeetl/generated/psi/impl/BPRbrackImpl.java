...
import com.intellij.ibeetl.generated.psi.BPRbrack;
...
public abstract class BPRbrackImpl extends BeetlCompositePsiElement implements BPRbrack {

  public BPRbrackImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitRbrack(this);
  }
