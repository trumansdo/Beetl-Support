...
import com.intellij.ibeetl.generated.psi.BPBitAndAssign;
...
public abstract class BPBitAndAssignImpl extends BeetlCompositePsiElement implements BPBitAndAssign {

  public BPBitAndAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitBitAndAssign(this);
  }
