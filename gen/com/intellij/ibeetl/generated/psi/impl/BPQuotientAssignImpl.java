...
import com.intellij.ibeetl.generated.psi.BPQuotientAssign;
...
public abstract class BPQuotientAssignImpl extends BeetlCompositePsiElement implements BPQuotientAssign {

  public BPQuotientAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitQuotientAssign(this);
  }
