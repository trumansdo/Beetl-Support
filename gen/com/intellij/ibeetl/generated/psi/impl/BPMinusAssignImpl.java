...
import com.intellij.ibeetl.generated.psi.BPMinusAssign;
...
public abstract class BPMinusAssignImpl extends BeetlCompositePsiElement implements BPMinusAssign {

  public BPMinusAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitMinusAssign(this);
  }
