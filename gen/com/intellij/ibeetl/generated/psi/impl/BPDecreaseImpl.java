...
import com.intellij.ibeetl.generated.psi.BPDecrease;
...
public abstract class BPDecreaseImpl extends BeetlCompositePsiElement implements BPDecrease {

  public BPDecreaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitDecrease(this);
  }
