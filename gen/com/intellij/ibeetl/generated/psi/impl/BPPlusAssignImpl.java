...
import com.intellij.ibeetl.generated.psi.BPPlusAssign;
...
public abstract class BPPlusAssignImpl extends BeetlCompositePsiElement implements BPPlusAssign {

  public BPPlusAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull BPVisitor<R> visitor) {
    return visitor.visitPlusAssign(this);
  }
